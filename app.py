...
tree0 = DecisionTreeClassifier(max_depth=50,
                               min_samples_split=2,
                               random_state=10)
tree0.fit(X0_train, y0_train)
print(f"Training Data Score: {tree.score(X0_train, y0_train)}")
print(f"Testing Data Score: {tree.score(X0_test, y0_test)}")
